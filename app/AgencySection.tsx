...
export function AgencySection() {
  ...
  return (
    <section
      ...
      className="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-12 text-white 
      scroll-smooth selection:bg-purple-600 selection:text-white overflow-visible"
    >
      ...
      {/* Main Layout */}
      <div className="container relative overflow-visible mx-auto grid grid-cols-1 lg:grid-cols-[1fr_0.9fr] 
      gap-10 sm:gap-16 items-center z-10 py-24 sm:py-32 lg:py-40">
        ...
        <div className="text-center lg:text-left max-w-2xl mx-auto lg:mx-0 px-2 sm:px-4 md:px-8">
          ...
          <div className="flex flex-wrap justify-center lg:justify-start gap-4">
            <motion.a
              href="#contact"
              className="inline-block border border-white text-white px-6 sm:px-8 py-2.5 rounded-xl font-semibold 
              transition-all duration-300 hover:bg-[#2563eb]/20 hover:border-[#3b82f6] hover:shadow-[0_0_20px_rgba(59,130,246,0.4)]"
        ...
        {/* Right Column */}
        <div className="relative flex items-center justify-center w-full mt-10 lg:mt-0 overflow-visible">
